...
$sql = "SELECT id, title, start, end, color FROM events WHERE family_name = '$family_name'
				UNION SELECT id, title, start, end, color FROM tbl_chores WHERE family_name = '$family_name'
				UNION SELECT id, title, start, end, color FROM tbl_mealplan WHERE family_name = '$family_name'";
